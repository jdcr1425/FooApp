...
class ThirdBlock extends StatefulWidget {
  ...
  static final String routeName = 'third_page';
}

class _ThirdBlockState extends State<ThirdBlock> {
  static final _emociones = [
    'Tristeza',
    'Enojo',
    'Normal',
    'Alegría',
  ...
  Future _registrar(Map<String, Object> datos, context) async {
    ...
    try {
      ...
      if (result.isNotEmpty && result[0].rawAddress.isNotEmpty) {
        ...
        olor.nivelEmocion = [
          _currentEmocionSelected,
          _emociones.indexOf(_currentEmocionSelected)
        ];
        olor.reaccion = [
          _currentReaccionSelected,
          _reacciones.indexOf(_currentReaccionSelected)
        ];
        olor.lugar = datos['lugar'];
        olor.sentimiento = datos['sentimiento'];
        olor.personalInformation = [
          user["Name"],
          user["Age"],
          user["Gender"],
          user["Profession"]
