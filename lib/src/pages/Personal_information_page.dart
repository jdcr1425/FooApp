                            ...
                            children: <Widget>[
                              Form(
                                ...
                                child: Padding(
                                  ...
                                  children: <Widget>[
                                    Center(child:Text("Regístrate", style: TextStyle(
                                                                    color: Colors.grey[800],
                                                                    fontWeight: FontWeight.bold,
                                                                    fontSize: 29))),
                                    SizedBox(height: 10.0,),
                                    TextFormField(
                                        decoration: InputDecoration(hintText: 'Digite su nombre' ),
                                        validator: (value) {
                                          if (value.isEmpty) {
                                      ...
                                      ,TextFormField(
                                        decoration: InputDecoration(hintText: 'Digite su edad' ),
                                        ...
                                        Row(
                                        children: <Widget>[
                                          Text("Sexo", style: TextStyle(fontSize: 16.0),),
                                          SizedBox(width: 10.0,),
                                          DropdownButton(
                                            value: _genderValue,
                                      ...
                                      TextFormField(
                                        decoration: InputDecoration(hintText: 'Digite su profesión'),
                                        validator: (value) {
                                          if (value.isEmpty) {
