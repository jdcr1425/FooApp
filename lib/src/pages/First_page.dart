...
class _FirstBlockState extends State<FirstBlock> {
  ...
  static final _olores=['Orina','Huevo podrido','Excremento','Fruta podrida','Aguas negras','Cebolla','Podredumbre','Gasolina','Residuos','Pescado','Humo','Ácido','Carnicerías y pollerías','Dulce'];
  ...
  var obje = {'Nombre': _currentItemSelected, 'num':_olores.indexOf(_currentItemSelected), 
              'intensidad' : sliderIntensidadValue, 'distincion': sliderDistincionValue, 'coordenadas':datos['Coordenadas'],
              'lugar': datos['lugar'], 'sentimiento' : _currentSentimientoSelected
              };

  Navigator.pushNamed(context, '/third', arguments: obje);
  }
    ...
    return Card(
      ...
      child: Container(
        ...
        mainAxisAlignment: MainAxisAlignment.spaceBetween,
          children: <Widget>[
            Text("¿A qué huele?", style: TextStyle(color: Colors.black, fontSize: 17.0)),
  ...
  Widget _intesidadOlor(){
    ...
    return Card(
      ...
      child: Container(
        ...
        child:Column(
          children: <Widget>[
            Text("¿La intensidad del olor es?",style: TextStyle(color: Colors.black, fontSize: 17.0)),
            Slider(
              min: 0.0,
              max: 10.0,
              divisions: 10,
  ...
  Widget _distincionOlor(){
    ...
    return Card(
      ...
      child: Container(
        ...
        child:Column(
          children: <Widget>[
            Text("¿Qué tanto se distingue el olor?",style: TextStyle(color: Colors.black, fontSize: 17.0)),
            Slider(
              min: 0.0,
              max: 10.0,
              divisions: 10,
    ...
    return Card(
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            Text("¿Este tipo de olor que tipo de sentimiento te genera?", style: TextStyle(color: Colors.black, fontSize: 17.0), textAlign:TextAlign.center),
            SizedBox(height: 10,)
            ,
          DropdownButton<String>(
